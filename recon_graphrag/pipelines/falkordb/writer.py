"""FalkorDB graph writer implementation.

Maps the neutral GraphDocument into FalkorDB (OpenCypher) using MERGE queries.
"""
...
class FalkorDBGraphWriter:
    """Write GraphDocument records to FalkorDB.
